...
Allow group 'development-domain'/'admin-group' to manage users in compartment development

Allow group 'development-domain'/'admin-group' to manage domains in compartment development

Allow group 'development-domain'/'admin-group' to manage groups in compartment development

Allow group 'development-domain'/'admin-group' to manage dynamic-groups in compartment development
